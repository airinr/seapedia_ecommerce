...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] text-[#23263B] font-sans antialiased selection:bg-emerald-100 selection:text-emerald-900 flex flex-col justify-between">
      <div>
        {/* HEADER / NAVIGATION */}
      ...
      {/* RE-DESIGNED SIMPLIFIED FOOTER */}
      <footer className="bg-white border-t border-slate-100 py-6 text-slate-400 text-[11px] font-medium font-sans">
        <div className="container mx-auto px-4 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-3">
          <div className="flex items-center gap-2">
            <span className="font-black text-[#0D241F] tracking-tight text-xs">
          ...
          <div className="flex gap-5 text-slate-400/90 font-semibold uppercase tracking-wider text-[9px]">
