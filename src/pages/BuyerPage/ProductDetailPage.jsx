  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#FAFAFA] text-center p-6">
        ...
        <button
          onClick={() => navigate("/")}
          className="bg-[#0D241F] text-white px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-wider border-none hover:bg-emerald-950 transition cursor-pointer shadow-sm"
        >
          Kembali ke Beranda
        </button>
      </div>
    ...
    <div className="min-h-screen bg-[#F8F9FA] text-[#23263B] font-sans antialiased pb-24">
      ...
      <header className="bg-white/80 border-b border-slate-200/60 sticky top-0 z-50 backdrop-blur-md shadow-xs">
        <div className="container mx-auto px-4 lg:px-12 py-3.5 flex justify-between items-center">
          <button
            onClick={() => navigate(-1)}
            className="text-xs font-black text-slate-600 flex items-center gap-2 border-none bg-transparent hover:text-[#0D241F] transition cursor-pointer uppercase tracking-wider"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="m15 18-6-6 6-6"/></svg> Kembali ke Toko
          </button>
          <button
      ...
      <main className="container mx-auto px-4 lg:px-12 pt-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="border-t border-b border-slate-200/80 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#0D241F] text-white rounded-full flex items-center justify-center font-black text-sm shadow-2xs border border-emerald-950">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="12" x="2" y="10" rx="2"/><path d="m22 10-8.97-6.3a2 2 0 0 0-2.06 0L2 10"/></svg>
                </div>
                <div>
              ...
              <div className="text-right">
                ...
                <span className="text-[11px] font-bold text-slate-600 flex items-center gap-1 justify-end mt-0.5">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg> {product.stores?.address || "Indonesia"}
                </span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-4 border border-slate-200/60 shadow-2xs flex items-center gap-6 text-[11px] font-bold text-slate-500">
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-600"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                100% Original
              </div>
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-600"><path d="M5 18H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h3.19M15 6h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-3.19"/><path d="M23 13v-2"/><path d="M11 6l3 3-3 3"/><path d="M14 9H9"/></svg>
                Instant SLA Ready
              </div>
            </div>
          </div>
